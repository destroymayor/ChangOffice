            ...
            <ScrollView>
              <View style={ styles.container }>
                <View style={ { flex: 1, width: '50%' } }>
                  ...
                  <Btn styless={ styles.button } ButtonsName={ `應附證件${'\n'}來源機關` } onPress={ this._NavigationBtn.bind(this, 'WebPage', '應附證件來源機關', 'http://www.xh-land.gov.tw/chaspx/content.aspx?web=184') } />
                  ...
                  <Btn styless={ styles.button } ButtonsName={ `地政規費${'\n'}收費標準` } onPress={ this._NavigationBtn.bind(this, 'WebPage', '地政規費收費標準', 'http://www.xh-land.gov.tw/chaspx/menulist.aspx?web=186') } />
